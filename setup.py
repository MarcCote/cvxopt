...
BLAS_LIB = ['mkl_intel_lp64', 'mkl_intel_thread', 'mkl_def', 'mkl_core', 'pthread', 'iomp5']
LAPACK_LIB = ['mkl_lapack95_lp64', 'mkl_intel_lp64', 'mkl_intel_thread', 'mkl_def', 'mkl_core', 'pthread', 'iomp5']
